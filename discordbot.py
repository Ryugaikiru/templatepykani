...
def randomweaponEN():
    ...
    weapon = {"Claw": '片手', "Knife": '片手', "Sword": '片手', "Katana": '片手', "Shotel": '片手', "Rapier": '片手', "Hand Axe": '片手', "Dagger": '片手', "Katar": '片手', "Butterfly Sword": '片手', "Beam Saber": '片手', "Heavy Sword": '片手', "Whip Sword": '片手', "Javelin": '片手', "Lance": '片手', "Trident": '片手', "Crowbar": '片手', "Bat": '片手', "Mace": '片手', "War Hammer": '片手', "Tonfa": '片手', "Flair": '片手', "Nunchaku": '片手', "Gada": '片手', "Revolver": '片手', "Shotgun": '片手', "Axe gun": '片手', "Sai": '片手', "Shield": '片手', "Sickle": '片手', "Jet": '片手', "Anchor": '片手', "Iron Fan": '片手', "Boomerang": '片手', "Dril": '片手', "Pile Banker": '片手', "Rex Skull": '片手', "Claymore": '両手', "Guandao": '両手', "Halberd": '両手', "Chainsaw": '両手', "Great Hammer": '両手', "Nodachi": '両手', "Double Saber": '両手', "Excalibur": '両手', "Bardiche": '両手', "3 Section Staff": '両手', "Seal": 'のりもの', "Scooter": 'のりもの'}
...
async def tournament(ctx):
    """武器抽選杯用のコマンド。カニ２種類と武器２セットを抽選する。"""
    weaponset1 = shuffling()
    weaponset2 = shuffling()
    arandomizer = '\n使用可能なカニ達 - ' + randomcrab() + ' ＆ ' + randomcrab() + ' \nセット1 - ' + weaponset1 + ' \n\nセット2 - ' + weaponset2
    await ctx.send(arandomizer)
...
async def tournamentEN(ctx):
    """Command for random weapon&crab tournament.Randomize 2 crabs and 2 weapon sets"""
